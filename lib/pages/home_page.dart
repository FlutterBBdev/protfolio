          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                // Hero Section
                Container(
                  // Use a minimum height instead of a fixed height so the
                  // layout can adapt on small test screens and avoid overflow.
                  ...
                  child: Column(
                    ...
                    children: [
                      // Avatar (uses Image.network with errorBuilder for tests/offline)
                      Container(
                        width: 150,
                        height: 150,
                        decoration: BoxDecoration(
